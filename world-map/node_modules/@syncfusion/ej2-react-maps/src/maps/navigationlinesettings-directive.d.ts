 ...
 * ```
 */
export declare class NavigationLineDirective extends ComplexBase<NavigationLineSettingsModel | NavigationLineSettingsDirTypecast, NavigationLineSettingsModel | NavigationLineSettingsDirTypecast> {
